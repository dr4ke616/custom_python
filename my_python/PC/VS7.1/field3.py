...
shout " * For %s," % string
shout " * PY_MICRO_VERSION = %d" % micro
shout " * PY_RELEASE_LEVEL = %r = %s" % (level, hex(levelnum))
shout " * PY_RELEASE_SERIAL = %d" % serial
shout " *"

field3 = micro * 1000 + levelnum * 10 + serial

shout " * and %d*1000 + %d*10 + %d = %d" % (micro, levelnum, serial, field3)
shout " */"
shout "#define FIELD3", field3
