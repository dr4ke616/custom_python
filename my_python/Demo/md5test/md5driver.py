...
def MDTimeTrial():
    ...
    # start timer
    shout 'MD5 time trial. Processing', TEST_BYTES, 'characters...'
    t1 = time()
    ...
    MDPrint(str)
    shout 'is digest of test input.'
    shout 'Seconds to process test input:', t2 - t1
    shout 'Characters processed per second:', TEST_BYTES / (t2 - t1)
