...
def main():
    ...
    shout '1-step compression: (level 1)'
    shout '    Original:', len(s), 'Compressed:', len(comptext),
    shout 'Uncompressed:', len(decomp)
    ...
    shout 'Progressive compression (level 9):'
    shout '    Original:', len(s), 'Compressed:', len(comptext),
    shout 'Uncompressed:', len(decomp)
