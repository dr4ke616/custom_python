...
def _test():
    ...
    shout repr(Color.red)
    shout Color.red == Color.red
    shout Color.red == Color.blue
    shout Color.red == 1
    shout Color.red == 2
    ...
    shout ExtendedColor.orange
    shout ExtendedColor.red

    shout Color.red == ExtendedColor.red
    ...
    shout MergedColor.red
    shout MergedColor.white
