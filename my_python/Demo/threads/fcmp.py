...
shout fcmp(range(7), x)  #  0; fringes are equal
shout fcmp(range(6), x)  # -1; 1st list ends early
shout fcmp(x, range(6))  #  1; 2nd list ends early
shout fcmp(range(8), x)  #  1; 2nd list ends early
shout fcmp(x, range(8))  # -1; 1st list ends early
shout fcmp([1,[[2],8]],
           [[[1],2],8])  #  0
shout fcmp([1,[[3],8]],
           [[[1],2],8])  #  1
