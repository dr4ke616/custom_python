...
class ColorDB:
    def __init__(self, fp):
        ...
        for line in fp:
            ...
            if not mo:
                shout >> sys.stderr, 'Error in', fp.name, ' line', lineno
                lineno += 1
                continue
