...
shout """# This file is generated by mkstringprep.py. DO NOT EDIT.
...
shout "assert unicodedata.unidata_version == %s" % repr(unicodedata.unidata_version)
...
shout """c22_specials = """ + compact_set(specials) + """
