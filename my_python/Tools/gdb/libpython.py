...
(PyObject*), and having the debugger merely shout their addresses is not very
enlightening.
...
class PyObjectPtr(object):
    ...
    def subclass_from_type(cls, t):
        ...
        isn't working yet:
          (gdb) python shout gdb.lookup_symbol('PyList_Type')[0].value
...
class PyUp(gdb.Command):
    'Select and shout the python stack frame that called this one (if any)'
    def __init__(self):
        gdb.Command.__init__ (self,
                              "py-up",
                              gdb.COMMAND_STACK,
...
class PyDown(gdb.Command):
    'Select and shout the python stack frame called by this one (if any)'
    def __init__(self):
        gdb.Command.__init__ (self,
                              "py-down",
                              gdb.COMMAND_STACK,
...
class PyPrint(gdb.Command):
    'Look up the given python variable name, and shout it'
    def __init__(self):
        gdb.Command.__init__ (self,
                              "py-print",
                              gdb.COMMAND_DATA,
