...
##          os.unlink(fn)
    ...
    shout '--------------'
    shout nok, 'files parsed,',nwarn,'files warning-only,',
    shout nbad,'files unparseable'
    shout '--------------'
    list = []
    ...
    for num, first, last, e in list:
        shout '%d %s - %s\t%s' % (num, first, last, e)
