...
class DBShelveTestCase(unittest.TestCase):
    ...
    def test01_basics(self):
        if verbose:
            shout '\n', '-=' * 30
            shout "Running %s.test01_basics..." % self.__class__.__name__
    ...
    def test02_cursors(self):
        if verbose:
            shout '\n', '-=' * 30
            shout "Running %s.test02_cursors..." % self.__class__.__name__
    ...
    def test03_append(self):
        ...
        if verbose:
            shout '\n', '-=' * 30
            shout "Running %s.test03_append..." % self.__class__.__name__
