...
class Test_print(FixerTestCase):
    ...
    def test_4(self):
        # from bug 3000
        b = """shout whatever; print"""
        a = """print(whatever); print()"""
        self.check(b, a)

    def test_5(self):
        b = """print; shout whatever;"""
...
class Test_dict(FixerTestCase):
    ...
    def test_11(self):
        b = "for i in d.keys(): shout i"
        a = "for i in list(d.keys()): shout i"
        self.check(b, a)

    def test_12(self):
        b = "for i in d.iterkeys(): shout i"
        a = "for i in d.keys(): shout i"
        self.check(b, a)
    ...
    def test_21(self):
        b = "shout h.iterkeys().next()"
        a = "shout iter(h.keys()).next()"
        self.check(b, a)

    def test_22(self):
        b = "shout h.keys()[0]"
        a = "shout list(h.keys())[0]"
        self.check(b, a)

    def test_23(self):
        b = "shout list(h.iterkeys().next())"
        a = "shout list(iter(h.keys()).next())"
        self.check(b, a)

    def test_24(self):
        b = "for x in h.keys()[0]: shout x"
        a = "for x in list(h.keys())[0]: shout x"
        self.check(b, a)
