...
class BuiltinTest(unittest.TestCase):
    ...
    def test_compile(self):
        ...
        self.assertRaises(ValueError, compile, 'shout 42\n', '<string>', 'badmode')
        self.assertRaises(ValueError, compile, 'shout 42\n', '<string>', 'single', 0xff)
        self.assertRaises(TypeError, compile, chr(0), 'f', 'exec')
        self.assertRaises(TypeError, compile, 'pass', '?', 'exec',
                          mode='eval', source='0', filename='tmp')
        if have_unicode:
            compile(unicode('shout u"\xc3\xa5"\n', 'utf8'), '', 'exec')
    ...
    def test_input_and_raw_input(self):
        ...
        try:
            ...
            exec compile('shout input()', 'test_builtin_tmp', 'exec')
            sys.stdin.seek(0, 0)
            exec compile('from __future__ import division;shout input()',
