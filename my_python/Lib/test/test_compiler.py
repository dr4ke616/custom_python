...
# How much time in seconds can pass before we shout a 'Still working' message.
...
class CompilerTest(unittest.TestCase):
    ...
    def check_lineno(self, node):
        try:
            ...
            shout node.__class__, node.lineno
            raise
    ...
    def testSourceCodeEncodingsError(self):
        ...
        sjis = "shout '\x83\x70\x83\x43\x83\x5c\x83\x93', '\n"
        ascii = "shout '12345678', '\n"
