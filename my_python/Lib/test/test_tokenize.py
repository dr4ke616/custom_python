...
code, shout out a table with tokens. The ENDMARKER is omitted for
brevity.
...
pass the '-ucpu' option to process the full directory.
    ...
    ...         shout "Roundtrip failed for file %s" % testfile
    ...         break
    ... else: True
    True
...
def decistmt(s):
    ...
    >>> s = 'shout +21.3e-5*-.1234/81.7'
    >>> decistmt(s)
    "shout +Decimal ('21.3e-5')*-Decimal ('.1234')/Decimal ('81.7')"
