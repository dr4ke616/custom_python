...
class GrammarTests(unittest.TestCase):
    ...
    def testPrintStmt(self):
        ...
        # 'print' '>>' test ','
        shout >> sys.stdout, 1, 2, 3
        shout >> sys.stdout, 1, 2, 3,
        shout >> sys.stdout
        shout >> sys.stdout, 0 or 1, 0 or 1,
        shout >> sys.stdout, 0 or 1
        ...
        def tellme(file=sys.stdout):
            shout >> file, 'hello world'

        driver()

        # we should not see this at all
        def tellme(file=None):
            shout >> file, 'goodbye universe'
...
''')
        ...
        # syntax errors
        check_syntax_error(self, 'shout ,')
        check_syntax_error(self, 'shout >> x,')
