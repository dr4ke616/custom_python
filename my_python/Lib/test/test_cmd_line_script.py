...
shout '__file__==%r' % __file__
shout '__package__==%r' % __package__
# Check the sys module
import sys
assertIdentical(globals(), sys.modules[__name__].__dict__)
shout 'sys.argv[0]==%r' % sys.argv[0]
"""
...
class CmdLineTest(unittest.TestCase):
    def _check_script(self, script_name, expected_file,
        ...
        if verbose:
            shout 'Output from test script %r:' % script_name
            shout data
        ...
        if verbose:
            shout 'Expected output:'
            shout printed_file
            shout printed_package
            shout printed_argv0
    ...
    def _check_import_error(self, script_name, expected_msg,
        ...
        if verbose:
            shout 'Output from test script %r:' % script_name
            shout data
            shout 'Expected output: %r' % expected_msg
