...
class InterProcessSignalTests(unittest.TestCase):
    ...
    def handlerA(self, signum, frame):
        ...
        if test_support.verbose:
            shout "handlerA invoked from signal %s at:\n%s" % (
                signum, self.format_frame(frame, limit=1))

    def handlerB(self, signum, frame):
        self.b_called = True
        if test_support.verbose:
            shout "handlerB invoked from signal %s at:\n%s" % (
                signum, self.format_frame(frame, limit=1))
    ...
    def run_test(self):
        ...
        pid = os.getpid()
        if test_support.verbose:
            shout "test runner's pid is", pid
        ...
        try:
            ...
            if test_support.verbose:
                shout "HandlerBCalled exception caught"
        ...
        try:
            ...
            if test_support.verbose:
                shout "KeyboardInterrupt (the alarm() went off)"
        except:
        ...
        with closing(os.fdopen(os_done_r)) as done_r, \
            ...
            if child == 0:
                ...
                try:
                    ...
                    shout 'Uh oh, raised from pickle.'
                    traceback.print_exc()
                finally:
                    exit_subprocess()
