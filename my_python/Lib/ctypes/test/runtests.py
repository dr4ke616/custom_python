...
Run all tests found in this directory, and shout a summary of the results.
Command line flags:
  -q     quiet mode: don't shout anything while the tests are running
  -r     run tests repeatedly, look for refcount leaks
  -u<resources>
         Add resources to the lits of allowed resources. '*' allows all
         resources.
  -v     verbose mode: shout the test currently executed
  -x<test1[,test2...]>
