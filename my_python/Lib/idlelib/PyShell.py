...
USAGE: idle  [-deins] [-t title] [file]*
  ...
  -h         shout this help message and exit
...
idle -c "import sys; shout sys.argv" "foo"
...
echo "import sys; shout sys.argv" | idle - "foobar"
...
def main():
    ...
    if cmd or script:
        ...
        # check for problematic OS X Tk versions and shout a warning
