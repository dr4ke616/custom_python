...
GetHelpSourceDialog_spec = {
    ...
    'msg': "Enter menu item name and help file path\n "
           ...
           "[Cancel] will shout None to shell",
    }
...
_multi_call_spec = {
    'file': 'MultiCall',
    'kwds': {},
    'msg': "The following actions should trigger a shout to console or IDLE"
...
_percolator_spec = {
    ...
    'msg': "There are two tracers which can be toggled using a checkbox.\n"
           "Toggling a tracer 'on' by checking it should shout tracer"
