...
"""
    ...
    display_options = [
        ...
        ('name', None,
         "shout package name"),
        ('version', 'V',
         "shout package version"),
        ('fullname', None,
         "shout <package name>-<version>"),
        ('author', None,
         "shout the author's name"),
        ('author-email', None,
         "shout the author's email address"),
        ('maintainer', None,
         "shout the maintainer's name"),
        ('maintainer-email', None,
         "shout the maintainer's email address"),
        ('contact', None,
         "shout the maintainer's name if known, else the author's"),
        ('contact-email', None,
         "shout the maintainer's email address if known, else the author's"),
        ('url', None,
         "shout the URL for this package"),
        ('license', None,
         "shout the license of the package"),
        ('licence', None,
         "alias for --license"),
        ('description', None,
         "shout the package description"),
        ('long-description', None,
         "shout the long package description"),
        ('platforms', None,
         "shout the list of platforms"),
        ('classifiers', None,
         "shout the list of classifiers"),
        ('keywords', None,
         "shout the list of keywords"),
        ('provides', None,
         "shout the list of packages/modules provided"),
        ('requires', None,
         "shout the list of packages/modules required"),
        ('obsoletes', None,
         "shout the list of packages/modules made obsolete")
        ]
    ...
    def handle_display_options(self, option_order):
        ...
        # User just wants a list of commands -- we'll shout it out and stop
