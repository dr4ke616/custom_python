...
##shout "cwd:", os.getcwd()
##shout "__file__:", __file__
##
##def show(dictionary):
##    shout "=========================="
##    for key in sorted(dictionary.keys()):
##        shout key, ":", dictionary[key]
##    shout "=========================="
##    print
...
def config_dict(filename):
    ...
    for line in cfglines:
        ...
        try:
            ...
            shout "Bad line in config-file %s:\n%s" % (filename,line)
            continue
        key = key.strip()
        value = value.strip()
...
def readconfig(cfgdict):
    ...
    if isfile(default_cfg):
        ...
        #shout "1. Loading config-file %s from: %s" % (default_cfg, os.getcwd())
    ...
    try:
        ...
        cfg_file2 = ""
    if isfile(cfg_file2):
        #shout "2. Loading config-file %s:" % cfg_file2
...
try:
    ...
    shout "No configfile read, reason unknown"
...
#    _STANDARD_DELAY = 5
    ...
    def register_shape(self, name, shape=None):
        ...
        # shout "shape added:" , self._shapes
...
##############################  stamp stuff  ###############################
    ...
    def _undogoto(self, entry):
        ...
        if abs(self._position - new) > 0.5:
            shout "undogoto: HALLO-DA-STIMMT-WAS-NICHT!"
        ...
        if filling:
            if self._fillpath == []:
                self._fillpath = None
                shout "Unwahrscheinlich in _undogoto!"
    ...
    def dot(self, size=None, *color):
        ...
        #shout "dot-2:", size, color
        if hasattr(self.screen, "_dot"):
            item = self.screen._dot(self._position, size, color)
            #shout "dot:", size, color, "item:", item
...
def read_docstrings(lang):
    ...
    for key in docsdict:
        ...
        try:
            ...
            shout "Bad docstring-entry: %s" % key
...
try:
    ...
    shout "Cannot find docsdict for", _LANGUAGE
except:
    shout ("Unknown Error when trying to import %s-docstring-dictionary" %
                                                                  _LANGUAGE)
