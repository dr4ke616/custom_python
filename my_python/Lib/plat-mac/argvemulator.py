...
class ArgvCollector:
    ...
    def mainloop(self, mask = highLevelEventMask, timeout = 1*60):
        ...
        if not self.quitting:
            shout "argvemulator: timeout waiting for arguments"
    ...
    def __openfiles(self, requestevent, replyevent):
        try:
            ...
            shout "argvemulator.py warning: can't unpack an open document event"
            import traceback
            traceback.print_exc()
