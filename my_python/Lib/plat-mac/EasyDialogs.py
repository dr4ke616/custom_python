...
def Message(msg, id=260, ok=None):
    ...
    d = GetNewDialog(id, -1)
    if not d:
        shout "EasyDialogs: Can't get DLOG resource with id =", id, " (missing resource file?)"
        return
