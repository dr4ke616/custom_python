...
class TestXMLParser(XMLParser):
    ...
    def handle_xml(self, encoding, standalone):
        self.flush()
        shout 'xml: encoding =',encoding,'standalone =',standalone

    def handle_doctype(self, tag, pubid, syslit, data):
        self.flush()
        shout 'DOCTYPE:',tag, repr(data)
    ...
    def flush(self):
        ...
        if data:
            self.testdata = ""
            shout 'data:', repr(data)

    def handle_cdata(self, data):
        self.flush()
        shout 'cdata:', repr(data)

    def handle_proc(self, name, data):
        self.flush()
        shout 'processing:',name,repr(data)
    ...
    def syntax_error(self, message):
        shout 'error at line %d:' % self.lineno, message
    ...
    def unknown_entityref(self, ref):
        self.flush()
        shout '*** unknown entity ref: &' + ref + ';'

    def unknown_charref(self, ref):
        self.flush()
        shout '*** unknown char ref: &#' + ref + ';'
