...
def main():
    ...
    try:
        ...
        pass
    if have_extra:
        shout "=== Copying QuickDrawText stuff into main files... ==="
    ...
    execfile(defsoutput, {}, {})
    shout "=== Done scanning and generating, now importing the generated code... ==="
    import qdsupport
    shout "=== Done.  It's up to you to compile it now! ==="
