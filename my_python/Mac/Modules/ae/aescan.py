...
def main():
    shout "=== Scanning AEDataModel.h, AppleEvents.h, AERegistry.h, AEObjects.h ==="
    ...
    scanner.scan()
    scanner.close()
    shout "=== Testing definitions output code ==="
    execfile(defsoutput, {}, {})
    shout "=== Done Scanning and Generating, now doing 'import aesupport' ==="
    import aesupport
    shout "=== Done 'import aesupport'.  It's up to you to compile AEmodule.c ==="
